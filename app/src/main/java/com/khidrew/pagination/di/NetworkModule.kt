...
import com.khidrew.Constants.API_KEY
import com.khidrew.Constants.AUTH_HEADER
import com.khidrew.Constants.BASE_URL
...
object NetworkModule {
    ...
    fun provideRetrofit(
        moshi: Moshi,
        callRetrofit: Call.Factory,
    ):Retrofit{
        return Retrofit.Builder()
            .baseUrl(BASE_URL)
            .callFactory(callRetrofit)
