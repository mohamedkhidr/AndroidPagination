package com.khidrew.pagination.core
...
abstract class BaseViewModel : ViewModel() {
    ...
    val cats: Flow<PagingData<CatListItem>> by lazy {
        dataSource.map { pagingData -> pagingData.map { CatListItem.CatItem(it) } }
            .map {
                it.insertSeparators { before, after ->
                    ...
                    if (before == null) {
                        return@insertSeparators CatListItem.SeparatorItem(nameOfAfterItem)
                    }
